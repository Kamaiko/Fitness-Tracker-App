...
For complete technical architecture, implementation details, and technology decisions, see **[TECHNICAL.md](TECHNICAL.md)**.

**Key technologies:**

- Database: WatermelonDB (offline-first) + Supabase (cloud sync)
- Storage: MMKV (encrypted local storage)
- Backend: Supabase Auth, PostgreSQL, Row-Level Security
- Charts: Victory Native (Skia-based rendering)

---

## Testing strategy

For complete testing strategy, quality assurance processes, and test infrastructure, see **[TESTING.md](TESTING.md)**.

**Summary:**

- Unit tests: Core business logic (Jest + React Native Testing Library)
- Integration tests: Database operations, Supabase sync
- Manual E2E: Real SQLite environment testing
- CI/CD: GitHub Actions (type-check, lint, tests)

---

## Project timeline

For detailed project milestones, task breakdown, and phase planning, see **[TASKS.md](TASKS.md)** and **[PHASE1_PLAN.md](PHASE1_PLAN.md)**.

**MVP Timeline:** 10-12 weeks development cycle
